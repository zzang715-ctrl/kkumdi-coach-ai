...
import { ResultReportDraftView } from "@/features/resultReports/ResultReportDraftView";
...
export default async function ResultReportPage({ params }: ResultReportPageProps) {
  ...
  return (
    <main className="min-h-screen bg-[#f7f3ea] text-slate-900">
      <WorkHeader
        label="결과보고서 AI"
        title="결과보고서 만들기"
        description="강의 기획과 현장 기록을 바탕으로 기관 제출용 결과보고서를 작성합니다."
      />
      <section className="mx-auto w-full max-w-7xl px-5 py-10 sm:px-8 lg:px-10">
        <ResultReportDraftView projectId={projectId} />
      </section>
    </main>
  );
}
